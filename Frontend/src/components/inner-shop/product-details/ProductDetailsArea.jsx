...
const ProductDetailsArea = ({ single_product }) => {
            ...
            <div className="row">
               ...
               <div className="col-xl-7 col-lg-6">
                  <div className="shop-details-content">
                     <h2 className="title">{single_product?.title || "Garden Adeline Life"}</h2>
                     <div className="product-review">
                        <div className="rating">
                           <Rating initialValue={single_product?.rating || 0} size={18} readonly={true} />
                        </div>
                        <span>{single_product?.rating ? `( Reviews ${single_product.rating} )` : "( Reviews 5.0 )"}</span>
                     </div>
                     <h3 className="price">${single_product?.price || 0}.00</h3>
                     ...
                     <div className="shop-details-qty">
                        <div className="cart-plus-minus">
                           <input type="text" onChange={handleSubmit} value={totalItems?.quantity || 0} readOnly />
                     ...
                     <div className="shop-details-bottom">
                        <ul className="list-wrap">
                           ...
                           <li className="sd-category">
                              ...
                              <Link to="/shop-details">{single_product?.category || "Business & Marketing"}</Link>
                           </li>
                           <li className="sd-tag">
