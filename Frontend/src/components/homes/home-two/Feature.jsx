            ...
            <div className="row justify-content-center">
               <div className="col-xl-6 col-lg-8">
                  <div className="section__title text-center mb-40">
                     ...
                     <p>When an unknown printer took a galley of type and scrambled, making the specimen book survive not only five centuries.</p>
                  </div>
               </div>
            </div>
            <div className="features__item-wrap">
               <div className="row justify-content-center">
                  {feature_data.filter((item) => item.page === "home_2").map((item) => (
