               ...
               <div className="row align-items-center">
                  ...
                  <div className="col-xl-5 col-lg-6">
                     <div className="video__content">
                        ...
                        <p>
                           Through research and discovery, we are changing the
                           world Groove’s intuitive shared steam
                        </p>
                        <Link to="/lesson" className="btn btn-three arrow-btn">
                           Join class Now <BtnArrow />
                        </Link>
                     </div>
                  </div>
               </div>
