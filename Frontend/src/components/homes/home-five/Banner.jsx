...
const Banner = () => {
   return (
      <section
         className="banner-area banner-bg-five tg-motion-effects"
         style={{ backgroundImage: 'url(/assets/img/banner/h5_hero_bg.jpg)' }}
      >
         <div
            className="banner-bg-five-shape"
            style={{ backgroundImage: 'url(/assets/img/banner/h5_hero_bg_shape.svg)' }}
         ></div>
