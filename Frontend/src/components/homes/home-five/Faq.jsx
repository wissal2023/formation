               ...
               <div className="col-lg-6 col-md-8 order-0 order-lg-2">
                  <div className="faq__img-three">
                     ...
                     <div className="faq__img-shape">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 718 554" fill="none" data-inject-url="http://127.0.0.1/skillgro-html/assets/img/others/h5_faq_img_shape.svg" className="injectable">
