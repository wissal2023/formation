...
const Courses = () => {
  return (
    <section
      className="courses-area-five section-py-140 courses__bg-four"
      style={{ backgroundImage: "url(/assets/img/bg/h6_courses_bg.jpg)" }} // Fixed the backgroundImage inline style
    >
              ...
              <div key={item.id} className="col-xl-3 col-lg-4 col-md-6">
                <div className="courses__item-seven">
                  <div className="courses__item-thumb-six">
                    ...
                    <Link to="/course-details" className="courses__wishlist-two">
                      <InjectableSvg
                    ...
                    <Link to="/courses" className="courses__item-tag-three">
                      {item.country}
                    </Link>
                  ...
                  <div className="courses__item-content-six">
                    <div className="courses__item-content-six-top">
                      <h2 className="title">
                        <Link to="/course-details">{item.tag}</Link>
                      </h2>
                    ...
                    <ul className="courses__item-meta-two list-wrap">
                      <li>
                        {item.country}{" "}
                        <InjectableSvg
                          src="/assets/img/icons/graph.svg"
                          alt=""
                          className="injectable"
                        />
                      </li>
                  ...
                  <div className="courses__item-bottom-three courses__item-bottom-four">
                    <ul className="list-wrap">
                      <li>
                        <i className="flaticon-book"></i>Lessons {item.lesson}
                      </li>
                      <li>
                        <i className="skillgro-group"></i>Students {item.student}
                      </li>
                    </ul>
                  </div>
                </div>
