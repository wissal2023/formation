            ...
            <div className="row">
               <div className="col-12">
                  <div className="section__title text-center mb-50">
                     ...
                     <p>When known printer took a galley of type scrambled make.</p>
                  </div>
               </div>
            </div>

            <div className="row justify-content-center">
               {course_data_two.filter((item) => item.page === "home_3").map((item) => (
                        ...
                        <div className="courses__item-content-three">
                           <ul className="courses__item-meta list-wrap">
                              ...
                              <li className="courses__wishlist">
                                 <a onClick={() => handleAddToWishlist(item)} className="course-heart-btn" style={{ cursor: "pointer" }}>
