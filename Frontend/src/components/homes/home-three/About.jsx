               ...
               <div className="row align-items-center justify-content-center">
                     ...
                     <div className="about__images-four">
                        ...
                        <div className="about__video" data-aos="fade-left" data-aos-delay="400">
                           <a 
                              ...
                              <i className="fas fa-play"></i> Watch our <br /> Video
                           </a>
                        </div>
                        ...
                        <div className="shape">
                           <img 
                              src="/assets/img/others/h3_about_shape01.svg" 
                              alt="shape" 
                              data-aos="fade-right" 
                              data-aos-delay="200" 
                           ...
                           />
                           <img 
                              src="/assets/img/others/h3_about_shape02.svg" 
                              alt="shape" 
                              data-aos="fade-right" 
                              data-aos-delay="200" 
                           />
                  ...
                  <div className="col-lg-7">
                     <div className="about__content-four">
                        ...
                        <div className="about__content-inner">
                           <div className="row">
                              <div className="col-md-6">
                                 <p>
                                    At Estuidar University, we prepare you to launch your career by providing a creative 
                                    and professional environment from which to learn all skillsets, work industry contacts, 
                        ...
                        <img 
                           src="/assets/img/others/h3_about_shape03.svg" 
                           alt="shape" 
