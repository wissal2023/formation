...
const tab_title = ["All Courses", "Design", "Business", "Development"];

// slider setting
const setting = {
  slidesPerView: 3,  // Set your desired value
  loop: true,
  spaceBetween: 30,  // Set your desired value
  observer: true,
  observeParents: true,
  autoplay: true,
  // Navigation arrows
  ...
  breakpoints: {
    ...
    '992': {
      slidesPerView: 2,  // Set your desired value
      spaceBetween: 20,   // Set your desired value
    },
    '768': {
      slidesPerView: 1,  // Set your desired value
      spaceBetween: 10,   // Set your desired value
    },
    '576': {
      slidesPerView: 1,  // Set your desired value
    },
          ...
          <div className="row justify-content-center">
            <div className="col-lg-6">
              <div className="section__title text-center mb-40">
                ...
                <p className="desc">When known printer took a galley of type scrambled make</p>
              </div>
