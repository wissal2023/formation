...
const setting = {
    slidesPerView: 3,  // Example value, adjust as needed
    spaceBetween: 30,  // Example value, adjust as needed
    observer: true,
    observeParents: true,
    loop: true,
    breakpoints: {
        '1500': {
            slidesPerView: 4,  // Example value, adjust as needed
        },
        '1200': {
            slidesPerView: 3,  // Example value, adjust as needed
        },
        '992': {
            slidesPerView: 2,  // Example value, adjust as needed
            spaceBetween: 20,
        },
        '768': {
            slidesPerView: 1,  // Example value, adjust as needed
            spaceBetween: 10,
        },
        '576': {
            slidesPerView: 1,  // Example value, adjust as needed
