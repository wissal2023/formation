...
const sidebar_data = [
   {
      ...
      sidebar_details: [
         ...
         { id: 3, link: "/Allformations", icon: "skillgro-book", title: "All Available Formation" },
         ...
         { id: 8, link: "/listUsers", icon: "skillgro-avatar", title: "utilisateurs" },
         { id: 9, link: "/formations", icon: "skillgro-book", title: "formations" },
         { id: 10, link: "/stepper", icon: "skillgro-label", title: "Ajouter formation" },
         //{ id: 5, link: "/convert", icon: "skillgro-book-2", title: "generator" },
