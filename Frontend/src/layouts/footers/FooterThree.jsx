      ...
      <footer className="footer__area-four footer__bg" style={{ backgroundImage:`url(/assets/img/bg/h5_footer.jpg)` }}>
                     ...
                     <div className="footer__widget">
                        ...
                        <div className="footer__content footer__content-two">
                           ...
                           <ul className="list-wrap">
                              <li><Link to="tel">+123 88 9900 456</Link></li>
                              <li className="email"><Link to="mailto@gmail.com">info@gmail.com</Link></li>
                           </ul>
                        </div>
                     </div>
                  </div>
         ...
         <div className="footer__shape-wrap">
            ...
            <div className="shape-inner">
               <svg xmlns="http://www.w3.org/2000/svg" width="149" height="297" viewBox="0 0 149 297" fill="none" data-inject-url="http://127.0.0.1/skillgro-html/assets/img/others/h5_footer_shape05.svg" className="injectable">
