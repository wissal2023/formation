...
fs
  ...
  .forEach(file => {
    ...
    db[model.name] = model.init(sequelize, Sequelize); // Use `init()`
  });
...
const { User, Historisation, Formation, DailyStreak, Recompense, Evaluation, NoteDigitale, Certification, Quiz, Question, QuizProg, Reponse, Document, video} = db;
