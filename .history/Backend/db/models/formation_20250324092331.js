...
Formation.hasMany(Quiz, { foreignKey: 'formation_id' });
...
User.hasMany(Formation, { foreignKey: 'created_by', onDelete: 'CASCADE' });
Formation.belongsTo(User, { foreignKey: 'created_by' });

Formation.hasMany(Video, { foreignKey: 'formation_id', onDelete: 'CASCADE' });
Video.belongsTo(Formation, { foreignKey: 'formation_id' });
