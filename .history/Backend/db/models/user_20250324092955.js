...
User.hasMany(Formation, { foreignKey: 'formation_id', onDelete: 'CASCADE' });
Formation.belongsTo(User, { foreignKey: 'formation_id' });

// User => Historisation (One-to-Many)
User.hasMany(Historisation, { foreignKey: 'historisation_id', onDelete: 'CASCADE' });
